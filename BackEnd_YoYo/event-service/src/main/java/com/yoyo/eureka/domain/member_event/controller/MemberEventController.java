...
public class MemberEventController {
    ...
    public ResponseEntity<?> getScheduleList(@RequestHeader("memberId") String memberId) {
        List<MemberEventDTO.Response> responses = memberEventService.getScheduleList(Long.parseLong(memberId));
    ...
    public ResponseEntity<?> getSchedule(@RequestHeader("memberId") String memberId,
        ...
        MemberEventDTO.Response response = memberEventService.getSchedule(Long.parseLong(memberId),
                                                                          memberEventId);
