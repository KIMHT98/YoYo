package com.yoyo.eureka.domain.event.controller;

import com.yoyo.eureka.domain.event.dto.EventDTO;
import com.yoyo.eureka.domain.event.dto.EventDTO.Response;
...
public class EventController {
    ...
    @PostMapping
    public ResponseEntity<?> createEvent(@RequestHeader("memberId") String memberId, @RequestBody EventDTO.Request request) {
        EventDTO.Response response = eventService.createEvent(Long.parseLong(memberId), request);
    ...
    public ResponseEntity<?> getEventList(@RequestHeader("memberId") String memberId) {
        List<EventDTO.Response> responses = eventService.getEventList(Long.parseLong(memberId));
    ...
    public ResponseEntity<?> updateEvent(@RequestHeader("memberId") String memberId,
        ...
        EventDTO.Response response = eventService.updateEvent(Long.parseLong(memberId), eventId, request);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
