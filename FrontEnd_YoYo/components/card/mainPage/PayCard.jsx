...
export default function PayCard({ data, account, onPress }) {
    ...
    return (
        <View style={styles.container}>
            <YoYoText type="subTitle" logo color={MainStyle.colors.white}>
                {data.memberName}님, 반갑습니다!
            </YoYoText>
            <MoneyCard account={account} money={data.balance} />
            {account.balance >= 0 ? (
                <View style={styles.buttons}>
                    <Pressable onPress={clickeGiveHandler}>
                        <YoYoText type="md" bold color="white">
                            옮기기
                        </YoYoText>
                    </Pressable>
                    <YoYoText type="subTitle" bold color="white">
                        |
                    </YoYoText>
