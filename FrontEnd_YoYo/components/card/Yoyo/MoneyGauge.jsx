  ...
  return (
    <View>
      <View style={styles.rowContainer}>
        <YoYoText type="xs" bold>받았어Yo</YoYoText>
        <YoYoText type="xs" bold>보냈어Yo</YoYoText>
      </View>
      <View style={styles.baseGuage}>
        <View style={[styles.mainGuage, { width: gaugeWidth }]} />
      </View>
      <View style={styles.rowContainer}>
        <YoYoText type="content" bold>{take}원</YoYoText>
        <YoYoText type="content" bold>{give}원</YoYoText>
      </View>
    </View>
  )
}
